...
public class TitleBar extends RelativeLayout {
    ...
    private void initView(AttributeSet attrs) {
        ...
        // 设置分割线
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.TitleBar, R.attr.title_bar_style, R.style.TitleBarLightStyle);
        mDividerColor = array.getColor(R.styleable.TitleBar_title_bar_divider_color, Color.WHITE);
        mDividerHeight = (int) array.getDimension(R.styleable.TitleBar_title_bar_divider_height, 0);
        setDividerColor(mDividerColor);
        setDividerHeight(mDividerHeight);

        // 设置背景颜色
        mBgColor = array.getColor(R.styleable.TitleBar_title_bar_bg_color, Color.WHITE);
        setBackgroundColor(mBgColor);


        // 设置左侧按钮
        mLeftDrawableResId = array.getResourceId(R.styleable.TitleBar_title_bar_left_drawable, R.drawable.icon_title_bar_back);
        setLeftImageView(mLeftDrawableResId);

        // 设置左侧文字
        mLeftText = array.getString(R.styleable.TitleBar_title_bar_left_text);
        mLeftTextColor = array.getColor(R.styleable.TitleBar_title_bar_left_text_color, Color.parseColor("#333333"));
        mLeftTextSize = (int) array.getDimension(R.styleable.TitleBar_title_bar_left_text_size, dip2px(14));
        setLeftText(mLeftText);
        setLeftTextColor(mLeftTextColor);
        setLeftTextSize(mLeftTextSize);

        // 设置右侧 文字
        mRightText = array.getString(R.styleable.TitleBar_title_bar_right_text);
        mRightTextColor = array.getColor(R.styleable.TitleBar_title_bar_right_text_color, Color.WHITE);
        mRightPressTextColor = array.getColor(R.styleable.TitleBar_title_bar_right_press_text_color, Color.WHITE);
        mRightTextSize = (int) array.getDimension(R.styleable.TitleBar_title_bar_right_text_size, dip2px(15));
        setRightText(mRightText);
        setRightTextColor(mRightTextColor, mRightPressTextColor);
        setRightTextSize(mRightTextSize);

        // 设置右侧按钮
        mRightDrawableID = array.getResourceId(R.styleable.TitleBar_title_bar_right_drawable, View.NO_ID);
        setRightImageView(mRightDrawableID);

        // 生成标题 容器
        initTitleContainer();
        mTitle = array.getString(R.styleable.TitleBar_tb_text);
        mSubTitle = array.getString(R.styleable.TitleBar_tb_sub_text);

        mTitleTextSize = (int) array.getDimension(R.styleable.TitleBar_title_bar_text_size, dip2px(17));
        mSubTitleTextSize = (int) array.getDimension(R.styleable.TitleBar_title_bar_sub_text_size, dip2px(14));
        mTitleColor = array.getColor(R.styleable.TitleBar_title_bar_text_color, Color.parseColor("#333333"));
        mSubTitleColor = array.getColor(R.styleable.TitleBar_title_bar_sub_text_color, Color.parseColor("#535353"));
